...
val OPENSSL_FILE: String get() = "\u002Ftmp\u002Ftmp7577905594317490537.c"
...
val _IO_stdin: CPointer<_IO_FILE>?
    get() = interpretCPointer<_IO_FILE>(kniBridge1959())

val _IO_stdout: CPointer<_IO_FILE>?
    get() = interpretCPointer<_IO_FILE>(kniBridge1960())

val _IO_stderr: CPointer<_IO_FILE>?
    get() = interpretCPointer<_IO_FILE>(kniBridge1961())

val stdin: CPointer<_IO_FILE>?
    get() = interpretCPointer<_IO_FILE>(kniBridge1962())

val stdout: CPointer<_IO_FILE>?
    get() = interpretCPointer<_IO_FILE>(kniBridge1963())
...
val sk_num: CPointer<CFunction<(CPointer<OPENSSL_STACK>?) -> Int>>?
    get() = interpretCPointer<CFunction<(CPointer<OPENSSL_STACK>?) -> Int>>(kniBridge1966())

val sk_value: CPointer<CFunction<(CPointer<OPENSSL_STACK>?, Int) -> COpaquePointer?>>?
    get() = interpretCPointer<CFunction<(CPointer<OPENSSL_STACK>?, Int) -> COpaquePointer?>>(kniBridge1967())

val sk_set: CPointer<CFunction<(CPointer<OPENSSL_STACK>?, Int, COpaquePointer?) -> COpaquePointer?>>?
    get() = interpretCPointer<CFunction<(CPointer<OPENSSL_STACK>?, Int, COpaquePointer?) -> COpaquePointer?>>(kniBridge1968())

val sk_new: CPointer<CFunction<(OPENSSL_sk_compfunc?) -> CPointer<OPENSSL_STACK>?>>?
    get() = interpretCPointer<CFunction<(OPENSSL_sk_compfunc?) -> CPointer<OPENSSL_STACK>?>>(kniBridge1969())

val sk_new_null: CPointer<CFunction<() -> CPointer<OPENSSL_STACK>?>>?
    get() = interpretCPointer<CFunction<() -> CPointer<OPENSSL_STACK>?>>(kniBridge1970())

val sk_free: CPointer<CFunction<(CPointer<OPENSSL_STACK>?) -> Unit>>?
    get() = interpretCPointer<CFunction<(CPointer<OPENSSL_STACK>?) -> Unit>>(kniBridge1971())

val sk_pop_free: CPointer<CFunction<(CPointer<OPENSSL_STACK>?, CPointer<CFunction<(COpaquePointer?) -> Unit>>?) -> Unit>>?
    get() = interpretCPointer<CFunction<(CPointer<OPENSSL_STACK>?, CPointer<CFunction<(COpaquePointer?) -> Unit>>?) -> Unit>>(kniBridge1972())
...
val sk_deep_copy: CPointer<CFunction<(CPointer<OPENSSL_STACK>?, OPENSSL_sk_copyfunc?, OPENSSL_sk_freefunc?) -> CPointer<OPENSSL_STACK>?>>?
    get() = interpretCPointer<CFunction<(CPointer<OPENSSL_STACK>?, OPENSSL_sk_copyfunc?, OPENSSL_sk_freefunc?) -> CPointer<OPENSSL_STACK>?>>(kniBridge1973())

val sk_insert: CPointer<CFunction<(CPointer<OPENSSL_STACK>?, COpaquePointer?, Int) -> Int>>?
    get() = interpretCPointer<CFunction<(CPointer<OPENSSL_STACK>?, COpaquePointer?, Int) -> Int>>(kniBridge1974())

val sk_delete: CPointer<CFunction<(CPointer<OPENSSL_STACK>?, Int) -> COpaquePointer?>>?
    get() = interpretCPointer<CFunction<(CPointer<OPENSSL_STACK>?, Int) -> COpaquePointer?>>(kniBridge1975())

val sk_delete_ptr: CPointer<CFunction<(CPointer<OPENSSL_STACK>?, COpaquePointer?) -> COpaquePointer?>>?
    get() = interpretCPointer<CFunction<(CPointer<OPENSSL_STACK>?, COpaquePointer?) -> COpaquePointer?>>(kniBridge1976())

val sk_find: CPointer<CFunction<(CPointer<OPENSSL_STACK>?, COpaquePointer?) -> Int>>?
    get() = interpretCPointer<CFunction<(CPointer<OPENSSL_STACK>?, COpaquePointer?) -> Int>>(kniBridge1977())

val sk_find_ex: CPointer<CFunction<(CPointer<OPENSSL_STACK>?, COpaquePointer?) -> Int>>?
    get() = interpretCPointer<CFunction<(CPointer<OPENSSL_STACK>?, COpaquePointer?) -> Int>>(kniBridge1978())

val sk_push: CPointer<CFunction<(CPointer<OPENSSL_STACK>?, COpaquePointer?) -> Int>>?
    get() = interpretCPointer<CFunction<(CPointer<OPENSSL_STACK>?, COpaquePointer?) -> Int>>(kniBridge1979())

val sk_unshift: CPointer<CFunction<(CPointer<OPENSSL_STACK>?, COpaquePointer?) -> Int>>?
    get() = interpretCPointer<CFunction<(CPointer<OPENSSL_STACK>?, COpaquePointer?) -> Int>>(kniBridge1980())

val sk_shift: CPointer<CFunction<(CPointer<OPENSSL_STACK>?) -> COpaquePointer?>>?
    get() = interpretCPointer<CFunction<(CPointer<OPENSSL_STACK>?) -> COpaquePointer?>>(kniBridge1981())

val sk_pop: CPointer<CFunction<(CPointer<OPENSSL_STACK>?) -> COpaquePointer?>>?
    get() = interpretCPointer<CFunction<(CPointer<OPENSSL_STACK>?) -> COpaquePointer?>>(kniBridge1982())

val sk_zero: CPointer<CFunction<(CPointer<OPENSSL_STACK>?) -> Unit>>?
    get() = interpretCPointer<CFunction<(CPointer<OPENSSL_STACK>?) -> Unit>>(kniBridge1983())

val sk_set_cmp_func: CPointer<CFunction<(CPointer<OPENSSL_STACK>?, OPENSSL_sk_compfunc?) -> OPENSSL_sk_compfunc?>>?
    get() = interpretCPointer<CFunction<(CPointer<OPENSSL_STACK>?, OPENSSL_sk_compfunc?) -> OPENSSL_sk_compfunc?>>(kniBridge1984())

val sk_dup: CPointer<CFunction<(CPointer<OPENSSL_STACK>?) -> CPointer<OPENSSL_STACK>?>>?
    get() = interpretCPointer<CFunction<(CPointer<OPENSSL_STACK>?) -> CPointer<OPENSSL_STACK>?>>(kniBridge1985())

val sk_sort: CPointer<CFunction<(CPointer<OPENSSL_STACK>?) -> Unit>>?
    get() = interpretCPointer<CFunction<(CPointer<OPENSSL_STACK>?) -> Unit>>(kniBridge1986())

val sk_is_sorted: CPointer<CFunction<(CPointer<OPENSSL_STACK>?) -> Int>>?
    get() = interpretCPointer<CFunction<(CPointer<OPENSSL_STACK>?) -> Int>>(kniBridge1987())

val SSLeay: CPointer<CFunction<() -> ULong>>?
    get() = interpretCPointer<CFunction<() -> ULong>>(kniBridge1988())

val SSLeay_version: CPointer<CFunction<(Int) -> CPointer<ByteVar>?>>?
    get() = interpretCPointer<CFunction<(Int) -> CPointer<ByteVar>?>>(kniBridge1989())

val PTHREAD_CANCELED: COpaquePointer?
    get() = interpretCPointer<COpaque>(kniBridge1990())

val get_rfc2409_prime_768: CPointer<CFunction<(CPointer<BIGNUM>?) -> CPointer<BIGNUM>?>>?
    get() = interpretCPointer<CFunction<(CPointer<BIGNUM>?) -> CPointer<BIGNUM>?>>(kniBridge1991())

val get_rfc2409_prime_1024: CPointer<CFunction<(CPointer<BIGNUM>?) -> CPointer<BIGNUM>?>>?
    get() = interpretCPointer<CFunction<(CPointer<BIGNUM>?) -> CPointer<BIGNUM>?>>(kniBridge1992())

val get_rfc3526_prime_1536: CPointer<CFunction<(CPointer<BIGNUM>?) -> CPointer<BIGNUM>?>>?
    get() = interpretCPointer<CFunction<(CPointer<BIGNUM>?) -> CPointer<BIGNUM>?>>(kniBridge1993())

val get_rfc3526_prime_2048: CPointer<CFunction<(CPointer<BIGNUM>?) -> CPointer<BIGNUM>?>>?
    get() = interpretCPointer<CFunction<(CPointer<BIGNUM>?) -> CPointer<BIGNUM>?>>(kniBridge1994())

val get_rfc3526_prime_3072: CPointer<CFunction<(CPointer<BIGNUM>?) -> CPointer<BIGNUM>?>>?
    get() = interpretCPointer<CFunction<(CPointer<BIGNUM>?) -> CPointer<BIGNUM>?>>(kniBridge1995())
...
val EVP_des_cfb: CPointer<CFunction<() -> CPointer<EVP_CIPHER>?>>?
    get() = interpretCPointer<CFunction<() -> CPointer<EVP_CIPHER>?>>(kniBridge1999())

val EVP_des_ede_cfb: CPointer<CFunction<() -> CPointer<EVP_CIPHER>?>>?
    get() = interpretCPointer<CFunction<() -> CPointer<EVP_CIPHER>?>>(kniBridge2000())

val EVP_des_ede3_cfb: CPointer<CFunction<() -> CPointer<EVP_CIPHER>?>>?
    get() = interpretCPointer<CFunction<() -> CPointer<EVP_CIPHER>?>>(kniBridge2001())

val EVP_rc2_cfb: CPointer<CFunction<() -> CPointer<EVP_CIPHER>?>>?
    get() = interpretCPointer<CFunction<() -> CPointer<EVP_CIPHER>?>>(kniBridge2002())

val EVP_bf_cfb: CPointer<CFunction<() -> CPointer<EVP_CIPHER>?>>?
    get() = interpretCPointer<CFunction<() -> CPointer<EVP_CIPHER>?>>(kniBridge2003())
...
val lh_error: CPointer<CFunction<(CPointer<OPENSSL_LHASH>?) -> Int>>?
    get() = interpretCPointer<CFunction<(CPointer<OPENSSL_LHASH>?) -> Int>>(kniBridge2012())

val lh_free: CPointer<CFunction<(CPointer<OPENSSL_LHASH>?) -> Unit>>?
    get() = interpretCPointer<CFunction<(CPointer<OPENSSL_LHASH>?) -> Unit>>(kniBridge2013())

val lh_insert: CPointer<CFunction<(CPointer<OPENSSL_LHASH>?, COpaquePointer?) -> COpaquePointer?>>?
    get() = interpretCPointer<CFunction<(CPointer<OPENSSL_LHASH>?, COpaquePointer?) -> COpaquePointer?>>(kniBridge2014())

val lh_delete: CPointer<CFunction<(CPointer<OPENSSL_LHASH>?, COpaquePointer?) -> COpaquePointer?>>?
    get() = interpretCPointer<CFunction<(CPointer<OPENSSL_LHASH>?, COpaquePointer?) -> COpaquePointer?>>(kniBridge2015())

val lh_retrieve: CPointer<CFunction<(CPointer<OPENSSL_LHASH>?, COpaquePointer?) -> COpaquePointer?>>?
    get() = interpretCPointer<CFunction<(CPointer<OPENSSL_LHASH>?, COpaquePointer?) -> COpaquePointer?>>(kniBridge2016())

val lh_doall: CPointer<CFunction<(CPointer<OPENSSL_LHASH>?, OPENSSL_LH_DOALL_FUNC?) -> Unit>>?
    get() = interpretCPointer<CFunction<(CPointer<OPENSSL_LHASH>?, OPENSSL_LH_DOALL_FUNC?) -> Unit>>(kniBridge2017())

val lh_doall_arg: CPointer<CFunction<(CPointer<OPENSSL_LHASH>?, OPENSSL_LH_DOALL_FUNCARG?, COpaquePointer?) -> Unit>>?
    get() = interpretCPointer<CFunction<(CPointer<OPENSSL_LHASH>?, OPENSSL_LH_DOALL_FUNCARG?, COpaquePointer?) -> Unit>>(kniBridge2018())

val lh_strhash: CPointer<CFunction<(CPointer<ByteVar>?) -> ULong>>?
    get() = interpretCPointer<CFunction<(CPointer<ByteVar>?) -> ULong>>(kniBridge2019())

val lh_num_items: CPointer<CFunction<(CPointer<OPENSSL_LHASH>?) -> ULong>>?
    get() = interpretCPointer<CFunction<(CPointer<OPENSSL_LHASH>?) -> ULong>>(kniBridge2020())

val lh_stats: CPointer<CFunction<(CPointer<OPENSSL_LHASH>?, CPointer<FILE>?) -> Unit>>?
    get() = interpretCPointer<CFunction<(CPointer<OPENSSL_LHASH>?, CPointer<FILE>?) -> Unit>>(kniBridge2021())

val lh_node_stats: CPointer<CFunction<(CPointer<OPENSSL_LHASH>?, CPointer<FILE>?) -> Unit>>?
    get() = interpretCPointer<CFunction<(CPointer<OPENSSL_LHASH>?, CPointer<FILE>?) -> Unit>>(kniBridge2022())

val lh_node_usage_stats: CPointer<CFunction<(CPointer<OPENSSL_LHASH>?, CPointer<FILE>?) -> Unit>>?
    get() = interpretCPointer<CFunction<(CPointer<OPENSSL_LHASH>?, CPointer<FILE>?) -> Unit>>(kniBridge2023())

val lh_stats_bio: CPointer<CFunction<(CPointer<OPENSSL_LHASH>?, CPointer<BIO>?) -> Unit>>?
    get() = interpretCPointer<CFunction<(CPointer<OPENSSL_LHASH>?, CPointer<BIO>?) -> Unit>>(kniBridge2024())

val lh_node_stats_bio: CPointer<CFunction<(CPointer<OPENSSL_LHASH>?, CPointer<BIO>?) -> Unit>>?
    get() = interpretCPointer<CFunction<(CPointer<OPENSSL_LHASH>?, CPointer<BIO>?) -> Unit>>(kniBridge2025())

val lh_node_usage_stats_bio: CPointer<CFunction<(CPointer<OPENSSL_LHASH>?, CPointer<BIO>?) -> Unit>>?
    get() = interpretCPointer<CFunction<(CPointer<OPENSSL_LHASH>?, CPointer<BIO>?) -> Unit>>(kniBridge2026())

val errno: Int
    get() = kniBridge2027()

val _IO_2_1_stdin_: _IO_FILE_plus
    get() = interpretPointed<_IO_FILE_plus>(kniBridge2028())

val _IO_2_1_stdout_: _IO_FILE_plus
    get() = interpretPointed<_IO_FILE_plus>(kniBridge2029())

val _IO_2_1_stderr_: _IO_FILE_plus
    get() = interpretPointed<_IO_FILE_plus>(kniBridge2030())

var stdin_: CPointer<_IO_FILE>?
    get() = interpretCPointer<_IO_FILE>(kniBridge2031())
    set(value) { kniBridge2032(value.rawValue) }

var stdout_: CPointer<_IO_FILE>?
    get() = interpretCPointer<_IO_FILE>(kniBridge2033())
    set(value) { kniBridge2034(value.rawValue) }

var stderr_: CPointer<_IO_FILE>?
    get() = interpretCPointer<_IO_FILE>(kniBridge2035())
    set(value) { kniBridge2036(value.rawValue) }

var sys_nerr: Int
    get() = kniBridge2037()
    set(value) { kniBridge2038(value) }

val sys_errlist: CArrayPointer<CPointerVar<ByteVar>>
    get() = interpretCPointer<CPointerVar<ByteVar>>(kniBridge2039())!!

val __tzname: CArrayPointer<CPointerVar<ByteVar>>
    get() = interpretCPointer<CPointerVar<ByteVar>>(kniBridge2040())!!

var __daylight: Int
    get() = kniBridge2041()
    set(value) { kniBridge2042(value) }

var __timezone: Long
    get() = kniBridge2043()
    set(value) { kniBridge2044(value) }
...
val ASN1_SEQUENCE_ANY_it: ASN1_ITEM
    get() = interpretPointed<ASN1_ITEM>(kniBridge2050())

val ASN1_SET_ANY_it: ASN1_ITEM
    get() = interpretPointed<ASN1_ITEM>(kniBridge2051())

val ASN1_ANY_it: ASN1_ITEM
    get() = interpretPointed<ASN1_ITEM>(kniBridge2052())

val ASN1_OBJECT_it: ASN1_ITEM
    get() = interpretPointed<ASN1_ITEM>(kniBridge2053())

val ASN1_BIT_STRING_it: ASN1_ITEM
    get() = interpretPointed<ASN1_ITEM>(kniBridge2054())
